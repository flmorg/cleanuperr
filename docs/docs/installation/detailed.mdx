...
1. Download the `Cleanuparr-{version}-win-amd64.zip` from [GitHub Releases](https://github.com/flmorg/cleanuperr/releases)
...
#### Installation Steps
1. Download the appropriate `.pkg` installer from [GitHub Releases](https://github.com/flmorg/cleanuperr/releases):
...
1. Download the appropriate zip file from [GitHub Releases](https://github.com/flmorg/cleanuperr/releases):
