...
<div style={{ fontSize: '1.2rem' }}>
    ...
    - Remove and block downloads blocked by qBittorrent or by Cleanuparr's **Content Blocker**. <Link to="/docs/configuration/content-blocker/general">[configuration]</Link>
