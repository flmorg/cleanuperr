  ...
  <div style={{ whiteSpace: 'pre' }}>
    ...
    cleanuperr:
      ...
      environment:
        ...
        - `}
        <Link to="/docs/configuration/download-cleaner/categories?DOWNLOADCLEANER__CATEGORIES__0__NAME">DOWNLOADCLEANER__CATEGORIES__0__NAME</Link>
        {`=tv-sonarr
        - `}
        <Link to="/docs/configuration/download-cleaner/categories?DOWNLOADCLEANER__CATEGORIES__0__MAX_RATIO">DOWNLOADCLEANER__CATEGORIES__0__MAX_RATIO</Link>
        {`=1
        - `}
        <Link to="/docs/configuration/download-cleaner/categories?DOWNLOADCLEANER__CATEGORIES__0__MIN_SEED_TIME">DOWNLOADCLEANER__CATEGORIES__0__MIN_SEED_TIME</Link>
        {`=0
        - `}
        <Link to="/docs/configuration/download-cleaner/categories?DOWNLOADCLEANER__CATEGORIES__0__MAX_SEED_TIME">DOWNLOADCLEANER__CATEGORIES__0__MAX_SEED_TIME</Link>
        {`=240
        - `}
        <Link to="/docs/configuration/download-cleaner/categories?DOWNLOADCLEANER__CATEGORIES__0__NAME">DOWNLOADCLEANER__CATEGORIES__1__NAME</Link>
        {`=radarr
        - `}
        <Link to="/docs/configuration/download-cleaner/categories?DOWNLOADCLEANER__CATEGORIES__0__MAX_RATIO">DOWNLOADCLEANER__CATEGORIES__1__MAX_RATIO</Link>
        {`=1
        - `}
        <Link to="/docs/configuration/download-cleaner/categories?DOWNLOADCLEANER__CATEGORIES__0__MIN_SEED_TIME">DOWNLOADCLEANER__CATEGORIES__1__MIN_SEED_TIME</Link>
        {`=0
        - `}
        <Link to="/docs/configuration/download-cleaner/categories?DOWNLOADCLEANER__CATEGORIES__0__MAX_SEED_TIME">DOWNLOADCLEANER__CATEGORIES__1__MAX_SEED_TIME</Link>
        {`=240
        - `}
        <Link to="/docs/configuration/download-cleaner/categories?DOWNLOADCLEANER__CATEGORIES__0__NAME">DOWNLOADCLEANER__CATEGORIES__2__NAME</Link>
        {`=cleanuperr-unlinked
        - `}
        <Link to="/docs/configuration/download-cleaner/categories?DOWNLOADCLEANER__CATEGORIES__0__MAX_RATIO">DOWNLOADCLEANER__CATEGORIES__2__MAX_RATIO</Link>
        {`=1
        - `}
        <Link to="/docs/configuration/download-cleaner/categories?DOWNLOADCLEANER__CATEGORIES__0__MIN_SEED_TIME">DOWNLOADCLEANER__CATEGORIES__2__MIN_SEED_TIME</Link>
        {`=0
        - `}
        <Link to="/docs/configuration/download-cleaner/categories?DOWNLOADCLEANER__CATEGORIES__0__MAX_SEED_TIME">DOWNLOADCLEANER__CATEGORIES__2__MAX_SEED_TIME</Link>
        {`=240
        ...
        {`=qBittorrent
        # - `}
        <Link to="/docs/configuration/download-client/general?QBITTORRENT__URL">QBITTORRENT__URL</Link>
        {`=http://localhost:8080
        # - `}
        <Link to="/docs/configuration/download-client/general?QBITTORRENT__URL_BASE">QBITTORRENT__URL_BASE</Link>
        {`=myCustomPath
        # - `}
        <Link to="/docs/configuration/download-client/general?QBITTORRENT__USERNAME">QBITTORRENT__USERNAME</Link>
        {`=user
        # - `}
        <Link to="/docs/configuration/download-client/general?QBITTORRENT__PASSWORD">QBITTORRENT__PASSWORD</Link>
        {`=pass
        # OR
        # - `}
        <Link to="/docs/configuration/download-client/general?DOWNLOAD_CLIENT">DOWNLOAD_CLIENT</Link>
        ...
        {`=deluge
        # - `}
        <Link to="/docs/configuration/download-client/general?DELUGE__URL">DELUGE__URL</Link>
        {`=http://localhost:8112
        # - `}
        <Link to="/docs/configuration/download-client/general?DELUGE__URL_BASE">DELUGE__URL_BASE</Link>
        {`=myCustomPath
        # - `}
        <Link to="/docs/configuration/download-client/general?DELUGE__PASSWORD">DELUGE__PASSWORD</Link>
        {`=pass
        # OR
        # - `}
        <Link to="/docs/configuration/download-client/general?DOWNLOAD_CLIENT">DOWNLOAD_CLIENT</Link>
        {`=transmission
        # - `}
        <Link to="/docs/configuration/download-client/general?TRANSMISSION__URL">TRANSMISSION__URL</Link>
        {`=http://localhost:9091
        # - `}
        <Link to="/docs/configuration/download-client/general?TRANSMISSION__URL_BASE">TRANSMISSION__URL_BASE</Link>
        {`=myCustomPath
        # - `}
        <Link to="/docs/configuration/download-client/general?TRANSMISSION__USERNAME">TRANSMISSION__USERNAME</Link>
        {`=user
        # - `}
        <Link to="/docs/configuration/download-client/general?TRANSMISSION__PASSWORD">TRANSMISSION__PASSWORD</Link>
        {`=pass
